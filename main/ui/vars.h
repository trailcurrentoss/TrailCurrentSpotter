...
enum FlowGlobalVariables {
    ...
    FLOW_GLOBAL_VARIABLE_MCU_MAC_ADDRESS = 11,
    FLOW_GLOBAL_VARIABLE_NUMBER_OF_SATELLITES = 12,
    FLOW_GLOBAL_VARIABLE_CURRENT_COURSE_OVER_GROUND = 13,
    FLOW_GLOBAL_VARIABLE_GNSS_MODE = 14,
    FLOW_GLOBAL_VARIABLE_CURRENT_ALTITUDE_VALUE = 15,
    FLOW_GLOBAL_VARIABLE_CURRENT_DATE_TIME = 16,
    FLOW_GLOBAL_VARIABLE_CURRENT_TEMPERATURE_VALUE = 17,
    FLOW_GLOBAL_VARIABLE_CURRENT_HUMIDITY_VALUE = 18,
    FLOW_GLOBAL_VARIABLE_USER_SETTINGS_CHANGED = 19,
    FLOW_GLOBAL_VARIABLE_SELECTED_THEME = 20,
    FLOW_GLOBAL_VARIABLE_SCREEN_TIMEOUT_VALUE = 21,
    FLOW_GLOBAL_VARIABLE_KEEP_SCREEN_ON_WHILE_DRIVING = 22,
    FLOW_GLOBAL_VARIABLE_CURRENT_TIME_ZONE_STRING = 23,
    FLOW_GLOBAL_VARIABLE_WIFI_CONNECTED = 24,
    FLOW_GLOBAL_VARIABLE_WEBSOCKET_CONNECTED = 25,
